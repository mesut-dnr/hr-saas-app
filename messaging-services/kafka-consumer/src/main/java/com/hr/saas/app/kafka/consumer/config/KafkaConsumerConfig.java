package com.hr.saas.app.kafka.consumer.config;

import com.hr.saas.app.kafka.config.data.KafkaConfigData;
import com.hr.saas.app.kafka.config.data.KafkaConsumerConfigData;
